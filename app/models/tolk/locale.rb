...
module Tolk
  class Locale < ActiveRecord::Base
    ...
    def phrases_without_translation(page = nil, options = {})
      ...
      pagination_options = {:page => page, :per_page => Phrase.per_page}.merge(options)
      result = phrases.page(pagination_options[:page]).per(pagination_options[:per_page])
    ...
    def search_phrases(query, scope, key_query, page = nil, options = {})
      ...
      pagination_options = {:page => page}.merge(options)
      
      phrases.page(pagination_options[:page])
    end
    ...
    def search_phrases_without_translation(query, page = nil, options = {})
      ...
      pagination_options = {:page => page}.merge(options)
      result = phrases.page(pagination_options[:page])
      ActiveRecord::Associations::Preloader.new result, :translations
      result
    end
    ...
    def find_phrases_with_translations(page, conditions = {})
      result = Tolk::Phrase.where({ :'tolk_translations.locale_id' => self.id }.merge(conditions)).
